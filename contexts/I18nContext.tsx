...
const MESSAGES: Record<Locale, Messages> = {
  zh: {
    ...
    'offline.title': '当前离线',
    'offline.message': '网络不可用，正在显示最近保存的数据。',
    'offline.lastUpdated': '上次更新：{time}',
    'offline.retry': '重试',
    'brand.shortName': '十秒到',
    ...
    'auth.accountLockedTimer': '账户已锁定，请 {minutes} 分钟后重试',
	    ...
	    'onboarding.prompt.title': '快速了解一下？',
	    'onboarding.prompt.body': '一分钟看懂余额=储值、积分、卡券使用规则。',
	    'onboarding.prompt.start': '开始',
	    'onboarding.prompt.noThanks': '不用了',
    ...
    'home.cta.orderOnline': '在线点餐',
    'home.cta.directions': '导航',
    'home.cta.call': '致电',
  ...
  en: {
    ...
    'offline.message': 'No network connection. Showing your last saved data.',
    'offline.lastUpdated': 'Last updated: {time}',
    'offline.retry': 'Retry',
    ...
    'auth.accountLockedTimer': 'Account locked. Try again in {minutes} min.',
	    ...
	    'onboarding.prompt.title': 'Take a quick tour?',
	    'onboarding.prompt.body': 'Learn balance (stored value), points, and coupons in 1 minute.',
	    'onboarding.prompt.start': 'Start',
	    'onboarding.prompt.noThanks': 'No thanks',
    ...
    'home.cta.orderOnline': 'Order online',
    'home.cta.directions': 'Directions',
    'home.cta.call': 'Call',
    ...
    'profile.section.support': 'Support',
	    ...
	    'profile.item.quickTour': 'Quick tour',
    ...
    'help.suggestion.failed': 'Failed to send, please try again',
	    ...
	    'helpChips.quickTour': 'Quick tour',
  ...
  es: {
    ...
    'offline.message': 'Sin conexión a internet. Mostrando los últimos datos guardados.',
    'offline.lastUpdated': 'Última actualización: {time}',
    ...
    'auth.accountLockedTimer': 'Cuenta bloqueada. Intenta en {minutes} min.',
	    ...
	    'onboarding.prompt.title': '¿Hacer un recorrido rápido?',
	    'onboarding.prompt.body': 'Aprende saldo (valor guardado), puntos y cupones en 1 minuto.',
	    'onboarding.prompt.start': 'Empezar',
	    'onboarding.prompt.noThanks': 'No, gracias',
    ...
    'home.cta.orderOnline': 'Pedir en línea',
    'home.cta.directions': 'Indicaciones',
    ...
    'profile.tapToView': 'Toca para ver',
    ...
    'profile.section.support': 'Soporte',
	    ...
	    'profile.item.quickTour': 'Guía rápida',
    ...
    'help.suggestion.failed': 'Error al enviar, intente de nuevo',
	    ...
	    'helpChips.quickTour': 'Guía rápida',
