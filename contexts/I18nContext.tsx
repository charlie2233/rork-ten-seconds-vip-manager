...
const MESSAGES: Record<Locale, Messages> = {
  zh: {
    ...
    'transactions.loginRequired': '请先登录查看账单记录',
    'transactions.balancePrefix': '余额',
    'transactions.desc.storeSpend': '门店消费 - {store}',
    'transactions.desc.memberDayBonus': '会员日充值赠送',
    'transactions.desc.accountTopUp': '账户充值',
    'transactions.desc.newYearGift': '新年会员礼',
    ...
    'memberCode.addToWallet': '添加到 Apple Wallet',
    'memberCode.syncError': '同步失败，请稍后重试',
    'memberCode.walletIosOnly': 'Apple Wallet 仅支持 iOS',
    'memberCode.walletTitle': 'Apple Wallet',
    'memberCode.walletOpenFailed': '无法打开 Wallet Pass，请检查网络连接。',
    'memberCode.walletAddFailed': '添加到 Wallet 失败，请稍后重试。',
    ...
    'profile.migration.confirmMessage': '将从 MenuSafe 系统同步您的余额和积分，确定继续吗？',
    ...
    'help.faq.points.a': '积分可用于兑换优惠券、礼品等。每消费$1可获得1积分，充值还可获得额外积分奖励。',
  ...
  en: {
    ...
    'transactions.loginRequired': 'Please sign in to view billing',
    'transactions.balancePrefix': 'Balance',
    'transactions.desc.storeSpend': 'In-store purchase - {store}',
    'transactions.desc.memberDayBonus': 'Member Day top-up bonus',
    'transactions.desc.accountTopUp': 'Account top-up',
    'transactions.desc.newYearGift': 'New Year member gift',
    ...
    'memberCode.walletTitle': 'Apple Wallet',
    'memberCode.walletOpenFailed': 'Could not open the pass. Please check your internet connection.',
    'memberCode.walletAddFailed': 'Failed to add pass to wallet.',
    ...
    'profile.migration.confirmMessage': 'This will sync your balance and points from the MenuSafe system. Continue?',
    ...
    'support.toolFailed': 'Tool failed',
  ...
  es: {
    ...
    'transactions.empty': 'Aún no hay facturación',
    'transactions.noTransactions': 'Aún no hay facturación',
    'transactions.loginRequired': 'Inicia sesión para ver la facturación',
    'transactions.balancePrefix': 'Saldo',
    'transactions.desc.storeSpend': 'Compra en tienda - {store}',
    'transactions.desc.memberDayBonus': 'Bono por recarga (Día de miembro)',
    'transactions.desc.accountTopUp': 'Recarga de cuenta',
    'transactions.desc.newYearGift': 'Regalo de Año Nuevo para miembros',
    ...
    'memberCode.addToWallet': 'Agregar a Apple Wallet',
    ...
    'memberCode.walletTitle': 'Apple Wallet',
    'memberCode.walletOpenFailed': 'No se pudo abrir el pase. Revisa tu conexión a internet.',
    'memberCode.walletAddFailed': 'No se pudo agregar el pase a la billetera.',
    ...
    'profile.migration.confirmMessage': 'Esto sincronizará su saldo y puntos del sistema MenuSafe. ¿Continuar?',
    ...
    'notifications.transactions': 'Facturación',
    ...
    'support.toolFailed': 'La herramienta falló',
